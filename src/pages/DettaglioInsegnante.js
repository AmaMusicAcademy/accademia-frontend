      ...
      <div className="max-w-xl mx-auto px-4 pt-4 space-y-5">
        ...
        <div className="flex items-center gap-2">
          ...
          {!attivo && ins.data_fine && (
            <span className="text-xs text-gray-400">Fine: {fmtData(ins.data_fine)}</span>
          )}
        </div>
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b">
            ...
            {!editAna ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => setEditAna(false)} className="text-gray-400">
                  <X size={14} />
                </button>
              </div>
            )}
        ...
        <div className="bg-white border rounded-xl px-4 py-3">
          <div className="flex items-center justify-between mb-1">
            <p className="text-sm font-semibold text-gray-800">Tariffa oraria</p>
            {!editTar ? (
          ...
          {!editTar ? (
            <p className="text-2xl font-bold text-gray-900">
              ...
              <span className="text-sm font-normal text-gray-400 ml-1">/ ora</span>
            </p>
          ) : (
            <div className="flex items-center gap-2 mt-2">
              ...
              <button onClick={handleSaveTar} disabled={savingTar}
                className="flex items-center gap-1 px-3 py-2 bg-blue-600 text-white rounded-xl text-sm font-medium disabled:opacity-40">
                <Check size={14} /> Salva
              </button>
              <button onClick={() => setEditTar(false)} className="p-2 text-gray-400 rounded-xl border">
                <X size={14} />
              </button>
            </div>
          )}
            ...
            <div className="bg-white border rounded-xl overflow-hidden divide-y divide-gray-50">
              {allievi.map(a => (
                <div key={a.id} className="flex items-center gap-3 px-4 py-3">
                  ...
                  <span className="text-sm text-gray-900">{a.nome} {a.cognome}</span>
                </div>
              ))}
            </div>
          )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="bg-white w-full max-w-sm rounded-2xl shadow-xl overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b">
              <h2 className="text-base font-semibold text-gray-900">Termina collaborazione</h2>
